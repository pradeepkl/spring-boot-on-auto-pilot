...
public class EkartDevAutoConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "ekart.dev.seeder", name = "enabled", havingValue = "true", matchIfMissing = true)
    @ConditionalOnBean(DevDataProvider.class)
    public DataSeeder dataSeeder(DevDataProvider devDataProvider, SeederProperties properties) {
